...
# Temps de génération: 2017-03-17 11:05:06 +0000
# ************************************************************
...
INSERT INTO `informations` (`id_information`, `idx_technicalnote`, `band`, `descriptio`, `date`, `image`, `stageplan`)
VALUES
	(1,1,'Pink Floyd','Pink Floyd est un groupe de rock progressif et psychédélique britannique formé en 1965 à Londres. Il est considéré comme un pionnier et un représentant majeur de ces styles musicaux.','2005-03-20 17:00:00','img/techimg/pinkfloyd.jpg','img/plans/pinkfloyd.jpg');
...
INSERT INTO `technicalnotes` (`id_technicalnote`, `idx_user`, `name`, `description`, `lastedit`, `pincode`, `linkhash`, `public`)
VALUES
	(1,3,'Pink Floyd','Fiche technique globale du groupe, informations générales pour les plateaux classiques.','2010-03-20 17:00:00',5643,'un hash généré par php',1);
...
INSERT INTO `users` (`id_users`, `username`, `email`, `password`, `remember`)
VALUES
	(1,'admin',NULL,'ici un hash','0'),
	(2,'bnicoud',NULL,'ici un hash','0'),
	(3,'mstasi',NULL,'ici un hash','0');
