<?php
  ...
  if (VALIDATE::exists($_POST['email'])) {

    // recuperation des infos nesaisaires pour le mail
    $infos = $technote->getMail();

    // on ajoute le destinataire
    $to = $_POST['email'];

    $subject = 'Fiche technique ' . $infos['band'];
    ...
    <body>
      <div><!--[if mso | IE]>
          ...
          <table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;width:600px;">
          <![endif]--><div class="mj-column-per-100 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%;"><table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0"><tbody><tr><td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="center"><div class="" style="cursor:auto;color:#000000;font-family:Ubuntu;font-size:18px;line-height:22px;text-align:center;">Bonjour</div></td></tr><tr><td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="center"><div class="" style="cursor:auto;color:#000000;font-family:Ubuntu;font-size:16px;line-height:22px;text-align:center;">Bastien souhaite vous partager la fiche technique du groupe <strong>'. $infos['name'] .'</strong>.</div></td></tr><tr><td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="center"><div style="cursor:auto;color:#000000;font-family:Ubuntu;font-size:16px;line-height:22px;text-align:center;">Suivez ce lien pour y acceder : <a href="http://bnicoud.eleves.mediamatique.ch/technote/public/technote'. $infos['link'] .'">http://bnicoud.eleves.mediamatique.ch/technote/public/technote'. $infos['link'] .'</a></div></td></tr><tr><td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="center"><div class="" style="cursor:auto;color:#000000;font-family:Ubuntu;font-size:16px;line-height:22px;text-align:center;">Le code PIN pour y acceder est : <strong>'. $infos['pincode'] .'</strong></div></td></tr></tbody></table></div><!--[if mso | IE]>
          </td></tr></table>
    ...
    $errors=[
        "errors"  => array(),
        "success" => array("email" => true)
    ];

    // renvoir une erreur au client
    echo json_encode($errors);

  } else {

    $errors=[
        "errors"  => array("eamil" => "Vous n'avez pas renseigné d'email"),
        "success" => array("email" => false)
    ];
